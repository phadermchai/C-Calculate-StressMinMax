...
int main()  //ฟังก์ชันการทำงานหลัก
{
    ...
    float S_max;    //ประตัวแปรสำหรับเก็บค่าความเค้นเฉื่อย S(y)) เป็นประเภท float (ทศนิยม)
    float S_min;    //ประตัวแปรสำหรับเก็บค่าความเค้นเฉื่อย S(y)) เป็นประเภท float (ทศนิยม)
